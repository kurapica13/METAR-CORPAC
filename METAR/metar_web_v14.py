...
def verificar_autenticacion():
    ...
    # Logo CORPAC en SVG profesional
    logo_svg = """
    <svg class="logo-corpac" viewBox="0 0 200 60" xmlns="http://www.w3.org/2000/svg">
        <!-- Fondo azul -->
        <rect width="200" height="60" rx="8" fill="#0b3d91"/>
        
        <!-- Texto CORPAC -->
        <text x="100" y="28" font-family="Arial, sans-serif" font-size="22" font-weight="700" 
              fill="white" text-anchor="middle">CORPAC</text>
        
        <!-- Subtítulo PERÚ -->
        <text x="100" y="48" font-family="Arial, sans-serif" font-size="11" font-weight="400" 
              fill="#a8c5f0" text-anchor="middle" letter-spacing="1.5">PERÚ</text>
        
        <!-- Elemento decorativo - avión estilizado -->
        <path d="M 30 30 L 45 25 L 55 30 L 45 35 Z" fill="white" opacity="0.3"/>
