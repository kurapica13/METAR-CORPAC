...
# ============================================
# FUNCIÓN RVR - EXACTAMENTE COMO EN AWOS
# ============================================
...
def codificar_fenomenos(texto):
    ...
    # ============================================
    # PASO 2: Procesar el texto restante para otros fenómenos
    # ============================================
    intensidades = {
...
def generar_metar(datos):
    try:
        ...
        # RVR - EXACTAMENTE LO QUE INGRESÓ EL OPERADOR
        ...
        # Usar los valores redondeados en el METAR
        ...
        registro = {
            ...
            'Temperatura': temp,           # Valor exacto guardado
            'Punto_Rocío': rocio,          # Valor exacto guardado
            'Humedad_Relativa_%': datos['hr'] if datos['hr'] else "",
            'QNH': qnh,                     # Valor exacto guardado
